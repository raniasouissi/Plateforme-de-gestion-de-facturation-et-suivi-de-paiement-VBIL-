          ...
          <div className="why-use-vbill-cards-container">
            <div className="why-use-vbill-card">
              <h2 className="why-use-vbill-card-title">
                Facturation adaptés au secteur du bâtiment
              </h2>
              <p
              ...
              >
                Grâce à notre logiciel de facturation, rédigez des factures
                adaptés aux attentes de votre secteur : multiples taux de TVA,
                attestations de TVA, gestion avancée de votre bibliothèque
                d’ouvrages, fournitures, main d’oeuvre… Toutes les marges sont
                ensuite calculées en temps réel, sans intervention de votre
                part.
              </p>
              <FaChevronDown
